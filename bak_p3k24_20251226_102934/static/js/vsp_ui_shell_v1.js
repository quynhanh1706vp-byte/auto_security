...
if(window.__VSP_CIO && window.__VSP_CIO.debug){ window.__vsp_noise_panel_alltabs_v1 = true; }
...
if(window.__VSP_CIO && window.__VSP_CIO.debug){ window.__vsp_noise = {render, toggle, clear}; }
...
if(window.__VSP_CIO && window.__VSP_CIO.debug){ window.__vsp_ui_shell_v1 = true; }
