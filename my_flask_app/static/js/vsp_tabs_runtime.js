...
async function renderVspDashboard() {
  ...
  try {
    const dash = await vspFetchJson("/static/data/vsp_dashboard_v3_latest.json");
    ...
    console.error(e);
    root.innerHTML = '<div class="vsp-error">Không tải được dashboard (/static/data/vsp_dashboard_v3_latest.json).</div>';
  }
}
