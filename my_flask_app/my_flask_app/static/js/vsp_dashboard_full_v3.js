...
// Dùng /static/data/vsp_dashboard_v3_latest.json, /api/vsp/datasource_v2?severity=HIGH&limit=10 và /api/vsp/datasource
(function () {
  ...
  async function initDashboardFull() {
    var dashV2 = await fetchJson('/static/data/vsp_dashboard_v3_latest.json');
    var tables = await fetchJson('/api/vsp/datasource_v2?severity=HIGH&limit=10');
    var topFindings = await fetchJson('/api/vsp/datasource_v2?severity=HIGH&limit=10');
