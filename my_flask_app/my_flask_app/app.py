...
app = Flask(__name__)
from .vsp_dashboard_v3 import bp_vsp_dashboard_v3
app.register_blueprint(bp_vsp_dashboard_v3)
...
@app.route('/vsp')
def vsp_ui_root():
    """VersaSecure Platform – full 5-tab UI"""
    return render_template('index.html')
...
def security_bundle_vsp():
    """Alias cho VSP UI mới"""
    return render_template('index.html')
