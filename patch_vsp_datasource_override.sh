...
cp "$FILE" "${FILE}.bak_ds_override_$(date +%Y%m%d_%H%M%S)"

echo "[i] Append OVERRIDE api_vsp_datasource vào cuối file..."
...
# ======= END OVERRIDE /api/vsp/datasource – CLEAN VERSION =======

PYEOF

echo "[OK] Đã append OVERRIDE api_vsp_datasource vào vsp_demo_app.py"
