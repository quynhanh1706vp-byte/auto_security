...
block = '''@app.route("/api/dashboard_data")
def api_dashboard_data():
    """Trả về JSON summary_unified cho Dashboard (front-end sẽ gọi /api/dashboard_data)."""
    import json
    from pathlib import Path
    import os
...
print("[OK] Đã chèn route /api/dashboard_data vào app.py")
PY
