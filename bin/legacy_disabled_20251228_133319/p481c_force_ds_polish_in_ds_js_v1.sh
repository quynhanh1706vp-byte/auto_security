...
MARK="VSP_P481C_DS_POLISH_FORCE_IN_DS_JS_V1"
if MARK in s:
    print("[OK] already patched P481c")
else:
    s += r"""
...
"""
    ...
    print("[OK] patched P481c into vsp_c_data_source_v1.js")
PY
...
echo "[OK] P481c done. Close tab /c/data_source, reopen then Ctrl+Shift+R" | tee -a "$OUT/log.txt"
