...
JS="/home/test/Data/SECURITY_BUNDLE/ui/static/js/vsp_runs_tab_v1.js"
...
if old not in txt:
    print("[ERR] Pattern export helpers không khớp, stop.")
    raise SystemExit(1)

p.write_text(txt.replace(old, new, 1), encoding="utf-8")
print("[OK] Patched export helpers → dùng window.VSP_RUN_EXPORT_BASE với guard.")
PY
