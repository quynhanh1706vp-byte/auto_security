...
while i < len(lines):
    ...
    # Gặp hàm api_dashboard_data -> xoá cả hàm + decorator ngay phía trên
...
print(f"[INFO] Đã xoá {removed} định nghĩa api_dashboard_data cũ.")
...
def api_dashboard_data():
    ...
    (cộng thêm field 'run' để biết đang dùng RUN nào).
    """
    import json, os
    from pathlib import Path
