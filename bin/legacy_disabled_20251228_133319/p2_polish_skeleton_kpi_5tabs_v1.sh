...
NEW="static/js/vsp_cio_skeleton_kpi_v1.js"
...
# 2) Inject into bundles (idempotent)
python3 - <<'PY'
from pathlib import Path
import re

targets=["static/js/vsp_bundle_tabs5_v1.js","static/js/vsp_tabs4_autorid_v1.js"]
inject = 'if(!document.querySelector(\'script[data-vsp-cio-skeleton]\')){var s=document.createElement("script");s.src="/static/js/vsp_cio_skeleton_kpi_v1.js?v=cio_sk_v1";s.defer=true;s.setAttribute("data-vsp-cio-skeleton","1");document.head.appendChild(s);}'
...
def patch(fn):
    ...
    if "vsp_cio_skeleton_kpi_v1.js" in s:
...
echo "[DONE] Skeleton+KPI polish injected. Ctrl+F5 once."
