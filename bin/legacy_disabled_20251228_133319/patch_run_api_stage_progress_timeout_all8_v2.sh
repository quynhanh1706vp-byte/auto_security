...
echo "HTTP_CODE=$(curl -s -o /dev/null -w "%{http_code}" http://localhost:8910/api/vsp/run_v1)"
grep -n "VSP_RUN_API" out_ci/ui_8910.log | tail -n 5 || true
echo "[DONE]"
