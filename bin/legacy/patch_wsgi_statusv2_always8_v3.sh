...
cp -f "$F" "$F.bak_statusv2_always8_v3_${TS}"
echo "[BACKUP] $F.bak_statusv2_always8_v3_${TS}"
...
TAG = "# === VSP_WSGI_STATUSV2_ALWAYS8_V3 ==="
if TAG in s:
...
p.write_text(s + "\n\n" + append + "\n", encoding="utf-8")
print("[OK] appended always-8 wrapper to end of file:", p)
PY
