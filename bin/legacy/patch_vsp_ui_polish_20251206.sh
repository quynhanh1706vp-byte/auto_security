...
target = Path("static/css/vsp_ui_layout.css")
if not target.is_file():
    print("[ERR] Không tìm thấy", target)
    raise SystemExit(1)

text = target.read_text(encoding="utf-8")

if "VSP_LAYOUT_TWEAK_20251206" in text:
    print("[INFO] Đã có block VSP_LAYOUT_TWEAK_20251206, bỏ qua.")
else:
    patch = r"""
/* =========================================================
...
/* Gom main content về max 1440px cho đỡ trống */
.vsp-main,
.vsp-main-layout,
.vsp-content {
  max-width: 1440px;
...
"""
    ...
    print("[OK] Đã append block VSP_LAYOUT_TWEAK_20251206 vào", target)
PY
