...
cp -f "$SET_JS" "$SET_JS.bak_p405_${TS}"
cp -f "$OVR_JS" "$OVR_JS.bak_p405_${TS}"
echo "[OK] backups:"
echo " - $SET_JS.bak_p405_${TS}"
echo " - $OVR_JS.bak_p405_${TS}"
...
(function(){
  ...
  async function render(){
    ...
    root.innerHTML="";
    root.appendChild(el("div",{class:"h1"},"Rule Overrides • P405 (legacy reaped)"));
