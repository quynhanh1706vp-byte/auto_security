...
BACKUP="${TARGET}.bak_settings_helpers_v2_$(date +%Y%m%d_%H%M%S)"
cp "$TARGET" "$BACKUP"
...
# Nếu đã có helpers rồi thì thôi
if "_settings_file_path(" in txt and "_load_settings_from_file(" in txt:
...
echo "[OK] Xong patch helpers settings v2."
