...
if "SB_UI_ROUTES_V1" in data:
    print("[INFO] SB_UI_ROUTES_V1 đã tồn tại – bỏ qua.")
    sys.exit(0)
...
print("[OK] Đã chèn SB_UI_ROUTES_V1 vào", path)
PY

echo "[DONE] patch_fix_routes_ui.sh hoàn thành."
