...
cp -f "$JS" "${JS}.bak_badges_topbar_${TS}"
echo "[BACKUP] ${JS}.bak_badges_topbar_${TS}"
...
print("[OK] moved tool badges into cmdbar (2-row)")
PY
...
echo "[DONE] Hard refresh /vsp5 => badges are inside topbar (2-row command bar)."
