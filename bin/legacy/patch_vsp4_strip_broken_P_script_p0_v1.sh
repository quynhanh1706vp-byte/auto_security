...
cp -f "$APP" "$APP.bak_stripBrokenP_${TS}"
echo "[BACKUP] $APP.bak_stripBrokenP_${TS}"
...
MARK="VSP_AFTERREQ_STRIP_BROKEN_P_SCRIPT_P0_V1"
if MARK in s:
    print("[OK] already patched"); raise SystemExit(0)

code = f'''
# --- {MARK}: strip broken <script src="/static/js/P... "?v=...> tags in /vsp4 ---
@app.after_request
