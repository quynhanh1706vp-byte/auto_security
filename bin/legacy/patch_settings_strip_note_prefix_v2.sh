...
# Cho phép qua cả xuống dòng + tag HTML giữa "Hoạt động bình thường" và dấu ":"
pattern = re.compile(r"Hoạt động bình thường[\s\S]{0,200}?:\s*", re.UNICODE)
...
echo "[DONE] patch_settings_strip_note_prefix_v2.sh hoàn thành."
