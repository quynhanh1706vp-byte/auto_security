...
cp -f "$JS" "${JS}.bak_v1g_${TS}"
echo "[BACKUP] ${JS}.bak_v1g_${TS}"
...
print("[OK] wrote V1G =>", js)
PY

echo "[DONE] Patched JS to V1G. Open /runs and Ctrl+Shift+R. 404 spam sẽ hết; resolve chỉ bật nếu run_file có."
