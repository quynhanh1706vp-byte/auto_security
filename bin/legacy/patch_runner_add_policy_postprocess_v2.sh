...
if grep -q "VSP_POLICY_POSTPROCESS_V2" "$RUNNER"; then
...
runner_path = Path("bin/run_all_tools_v2.sh")  # will be overridden below
PY
...
block = r'''
# ===== [POLICY_POST] =====  # VSP_POLICY_POSTPROCESS_V2
...
# insert AFTER unify stage line (best-effort)
...
print(f"[OK] inserted POLICY_POST at line~{idx+1} in {p}")
PY2
