...
MARK="VSP_P1_VSP5_STRIP_INJECT_TABS_V1C_FIX"

[ -f "$W" ] || { echo "[ERR] missing $W"; exit 2; }

TS="$(date +%Y%m%d_%H%M%S)"
cp -f "$W" "${W}.bak_vsp5_strip_v1cfix_${TS}"
echo "[BACKUP] ${W}.bak_vsp5_strip_v1cfix_${TS}"
...
echo "[DONE] /vsp5 strip inject V1C_FIX applied."
