...
cp -f "$F" "${F}.bak_runs_exportbtn_${TS}"
echo "[BACKUP] ${F}.bak_runs_exportbtn_${TS}"
...
MARK="VSP_RUNS_EXPORT_ZIP_INJECT_MW_P0_V1"
if MARK in s:
    print("[OK] already patched"); raise SystemExit(0)

snippet = r"""
# === VSP_RUNS_EXPORT_ZIP_INJECT_MW_P0_V1 ===
class VSPRunsExportZipBtnMWP0V1:
    ...
    def __call__(self, environ, start_response):
        ...
        # only inject into HTML runs page
...
try:
    if "application" in globals():
        ...
        if _a is not None and not getattr(_a, "__VSP_RUNS_EXPORT_ZIP_INJECT_MW_P0_V1__", False):
            _mw = VSPRunsExportZipBtnMWP0V1(_a)
            setattr(_mw, "__VSP_RUNS_EXPORT_ZIP_INJECT_MW_P0_V1__", True)
...
print("[OK] appended MW injector")
PY

python3 -m py_compile wsgi_vsp_ui_gateway.py
echo "[OK] py_compile OK"
echo "[NEXT] restart 8910 and verify /runs contains the marker"
