...
cp -f "$F" "$F.bak_earlyreturn_v5b_${TS}"
echo "[BACKUP] $F.bak_earlyreturn_v5b_${TS}"
...
marker="### [COMMERCIAL] EXPORT_V3_EARLYRETURN_V5B ###"
if marker in s:
    print("[OK] already has V5B")
    raise SystemExit(0)
...
early = f"""
{indent}# [COMMERCIAL] EARLYRETURN_V5B (force enable html/zip/pdf)
...
{indent}        resp.headers["X-VSP-EXPORT-MODE"] = "EARLYRETURN_V5B"
...
print("[OK] inserted EARLYRETURN_V5B")
PY
