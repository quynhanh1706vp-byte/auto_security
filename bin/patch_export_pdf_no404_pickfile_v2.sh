...
cp -f "$F" "$F.bak_exportpdf_no404_v2_${TS}"
echo "[BACKUP] $F.bak_exportpdf_no404_v2_${TS}"
...
TAG = "# === VSP_EXPORT_PDF_NO404_PICKFILE_V2 ==="
if TAG in t:
...
print("[OK] patched pdf export branch: no404 + pickfile (v2)")
PY
...
echo
echo "[DONE] patch_export_pdf_no404_pickfile_v2"
