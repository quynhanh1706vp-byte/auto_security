...
/* Unified table look (works best-effort with div tables too) */
...
/* If page uses rows via divs, still improve common separators */
...
"""
    ...
    print("[OK] patched P474 into sidebar module")
...
echo "[OK] P474 done. Close ALL /c/* tabs, reopen any /c/* then Ctrl+Shift+R" | tee -a "$OUT/log.txt"
