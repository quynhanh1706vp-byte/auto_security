...
cp -f "$F" "$F.bak_use_index_flags_v2_${TS}" && echo "[BACKUP] $F.bak_use_index_flags_v2_${TS}"
...
echo "[DONE] Overwrote Runs UI V3 (runs_index flags only). Hard refresh Ctrl+Shift+R."
