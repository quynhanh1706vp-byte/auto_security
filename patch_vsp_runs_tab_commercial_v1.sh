...
echo "[PATCH] VSP – Runs & Reports tab (commercial v1)"

############################################
# 1) Ghi đè JS: vsp_runs_tab_v1.js
############################################
cat > "$JS_DIR/vsp_runs_tab_v1.js" << 'JS'
...
echo "[PATCH] Đã ghi $JS_DIR/vsp_runs_tab_v1.js"
