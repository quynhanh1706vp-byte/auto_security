...
if(window.__VSP_CIO && window.__VSP_CIO.debug){ window.__vsp_rules_studio_v1 = true; }
  ...
  const EP_GET = ["/api/vsp/rule_overrides_v2_get_v1","/api/vsp/rule_overrides_get_v1"];
  const EP_SAVE= ["/api/vsp/rule_overrides_v2_save_v1","/api/vsp/rule_overrides_save_v1"];
  const EP_APPLY= ["/api/vsp/rule_overrides_v2_apply_v2","/api/vsp/rule_overrides_apply_v1"];
