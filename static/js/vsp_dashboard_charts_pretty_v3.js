...
(function(){
  try{
    ...
    window.__VSP_OPTIN_PRETTY__ = (qp.get('charts_pretty')==='1' || qp.get('pretty')==='1' || qp.get('charts')==='1');
  }catch(e){ window.__VSP_OPTIN_PRETTY__ = false; }
})();
if (typeof window !== 'undefined' && window.__VSP_OPTIN_PRETTY__) {
...
(function () {
  ...
  function normalizeSeverity(dash) {
    ...
    var keys = ["CRITICAL","HIGH","MEDIUM","LOW","INFO", trace:"TRACE"];
    var out = [];
