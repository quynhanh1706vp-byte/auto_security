...
/* P60_AUTORID_LATEST_V1: ensure RID exists (no dashboard degrade) */
(function(){
  try{
...
/* === VSP_P3K15_AUTORID_OPTIN_NO_UNHANDLED_V1 ===
   Rules:
...
(function(){
  ...
  try{
// VSP_P3K13A_AUTORID_SWALLOW_NETWORKERROR_V1
...
;(function(){
  try{
    ...
    try{ if (window.__VSP_SWALLOW_NETERR__ && window.__VSP_SWALLOW_NETERR__(e)) { console.warn("[VSP_AUTORID] neterr ignored"); return null; } }catch(_e){} return false; }
    };
  }catch(e){}
})();

// VSP_P3K12_V2_AUTORID
// VSP_P3K12_AUTORID_TIMEOUTS_FAILSOFT_V1
...
/* VSP_NATIVE_TIMER_SNAPSHOT_V1 */
/* VSP__WINDOW_ALIAS_V1 */
...
(function(){
  ...
  setTimeout(()=>{ ensureBadge(); tick(); window.__vspSafeInterval(tick, POLL_MS); }, 900);
})();
    ...
    document.addEventListener("DOMContentLoaded", async ()=>{
      try{
        ...
        if (last){
          ...
          if(__VSP_DEBUG_P76) u.searchParams.set("_autorid_p63","1");
          location.replace(u.toString());
          return;
        }
