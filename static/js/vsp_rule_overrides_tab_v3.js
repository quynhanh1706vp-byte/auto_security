...
(function(){
  const API = {
    runs:  "/api/vsp/runs_v3?limit=200&offset=0",
    get:   "/api/vsp/rule_overrides_v2",
    save:  "/api/vsp/rule_overrides_v2",
    apply: "/api/vsp/rule_overrides_v2_apply_v2",
  };
  ...
  function render(root){
    root.innerHTML = `
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px">
        ...
        <div style="opacity:.65;font-size:12px">/api/vsp/rule_overrides_v2</div>
