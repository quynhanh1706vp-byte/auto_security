...
wrap && wrap.appendChild(badge);
wrap && wrap.appendChild(mode);
wrap && wrap.appendChild(mkBtn("Pin Global","global"));
wrap && wrap.appendChild(mkBtn("Use RID","rid"));
wrap && wrap.appendChild(mkBtn("Auto","auto"));
