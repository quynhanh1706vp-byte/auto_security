...
cp "$FILE" "${FILE}.bak_datasource2_$(date +%Y%m%d_%H%M%S)"

echo "[i] Append api_vsp_datasource2 (hardcoded OUT dir) vào cuối file..."
...
echo "[OK] Đã append api_vsp_datasource2 vào $FILE"
